...
// <nav class="border-gray-200 px-2 sm:px-4 py-2.5 rounded bg-gray-900 lg:hidden">
//   <div class="container flex flex-wrap items-center justify-between mx-auto lg:hidden">
//     <button
//       onClick={() => {
//         console.log("resssing");
...
//     showModal ? "duration-500 translate-x-0" : "duration-500 -translate-x-full"
